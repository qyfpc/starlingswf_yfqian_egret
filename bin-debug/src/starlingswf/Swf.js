...
(function (starlingswf) {
    ...
    var Swf = (function () {
        ...
        __egretProto__.createSprite = function (name, data, sprData) {
        ...
        __egretProto__.createMovie = function (name, data) {
            if (data === void 0) { data = null; }
        ...
        __egretProto__.createImage = function (name, data) {
            if (data === void 0) { data = null; }
        ...
        __egretProto__.createButton = function (name, data, sprData) {
            if (data === void 0) { data = null; }
            if (sprData === void 0) { sprData = null; }
            if (sprData == null) {
                //                trace.log("获得链接"+name);
        ...
        __egretProto__.createS9Image = function (name, data) {
            if (data === void 0) { data = null; }
        ...
        __egretProto__.createShapeImage = function (name, data) {
            if (data === void 0) { data = null; }
            var bitmap = this._assetManager.createBitmap(name);
        ...
        __egretProto__.createTextField = function (name, data) {
            if (data === void 0) { data = null; }
