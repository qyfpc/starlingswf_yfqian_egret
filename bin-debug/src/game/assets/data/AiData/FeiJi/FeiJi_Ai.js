...
(function (FeiJi) {
     ...
     * @登陆逻辑类
     */
    var FeiJi_Ai = (function (_super) {
        __extends(FeiJi_Ai, _super);
        function FeiJi_Ai() {
            _super.call(this);
            var aNum = 1;
            var bNum = 1;
            ...
            this.FeiJi_B(bNum);
            aNum++;
            spr_Ui.FeiJi_spr.UIFeiJi.SprUi.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function () {
                this.FeiJi_A(aNum);
                this.FeiJi_B(bNum);
                aNum++;
                if (aNum == 16) {
        ...
        var __egretProto__ = FeiJi_Ai.prototype;
    ...
    FeiJi.FeiJi_Ai = FeiJi_Ai;
    FeiJi_Ai.prototype.__class__ = "FeiJi.FeiJi_Ai";
})(FeiJi || (FeiJi = {}));
